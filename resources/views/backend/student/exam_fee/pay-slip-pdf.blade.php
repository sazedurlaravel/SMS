...
<body>
  <div class="container">
  	<div class="row">
        ...
        $registrationfee =
        App\FeeAmount::where('fee_category_id','3')->where('class_id',$details->class_id)->first();
        ...
        @endphp
  			...
  			<p style="font-weight: bold;padding-top: 25px;text-align: center">Student Exam Fee</p>
  		</div>
  		<div class="col-md-12">
            ...
            <tr>
             ...
             <tr>
              <td style="width:50%;text-align: justify;padding-left: 5px"><strong>Exam Fee</strong></td>
