              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="{{route('employee.edit',$value->id)}}" class="btn btn-sm btn-success"><i class='fa fa-edit'></i></a>
                     ...
                     <a target="_blank" href="" class="btn btn-sm btn-info"><i class='fa fa-eye'></i></a>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$value->code}}</td>
                    <td> 
                      <img src="{{(!empty($value->image))? asset('backend/img/student/'.$value->image):asset('no_img.png')}}" id="showimg" style="width: 50px;height: 50px;">
                        </div></td>
